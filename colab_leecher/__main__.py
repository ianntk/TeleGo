...
@colab_bot.on_message(filters.command("torrent") & filters.private)
async def torrent_leech(client, message):
    global BOT, src_request_msg
    BOT.Mode.mode = "leech"
    BOT.Mode.ytdl = False

    text = (
        "<b>🧲 Send Me a TORRENT LINK »</b>\n\n"
        "Supported formats:\n"
        "  • Magnet link  <code>magnet:?xt=urn:btih:…</code>\n"
        "  • .torrent file URL  <code>https://…/file.torrent</code>\n\n"
        "🦀 Optional modifiers on separate lines:\n"
        "<code>[Custom filename.mkv]</code>\n"
        "<code>{zip password}</code>\n"
        "<code>(unzip password)</code>"
    )
